...
#========================================================= Question 2 =========================================================
    ...
    def drop_neko(self):
        ...
        while(True):
            for y in range(1, 9):
                for x in range(8):
                    if self.check[y][x] == 0 or self.check[y][x] == 7:
                        for k in range(7): # k代表圖案，範圍是0~6的編號圖形
                            self.check[y][x] == k
                    else:
                        return True # 回到迴圈繼續下一次的判斷
...
#========================================================= Question 3 =========================================================
    ...
    def over_neko(self):
        ...
        # <<<將你的程式寫在這邊>>>
        while(True):
            if self.over[y][x] > self.over[9][x]: #當控制y軸的數字大於10時，就終止迴圈，離開遊戲
                return False
            else:
                return True
