...
#========================================================= Question 1 =========================================================
    ...
    def check_neko(self):
        ...
        for y in range(1, 9): 
            for x in range(8):
                if self.check[y][x] > 0:
                    if self.check[y-1][x+1] == self.check[y][x] and self.check[y+1][x] == self.check[y+1][x-1]:
                        self.neko[y-1][x+1] = 7
                        self.neko[y][x] = 7
                        self.neko[y+1][x-1] = 7
        for y in range(1, 9): 
...
#========================================================= Question 2 =========================================================
    ...
    def drop_neko(self):
        ...
        for y in range(1, 9): 
            for x in range(8):
                if self.check[y][x] > 0:
                    if self.check[y-1][x]==0:
                        self.check[y][x] = self.check[y-1][x]
                        self.neko[y][x]=7
                        return False
                    if self.check[y-1][x]!=self.check[y+1][x]:
                        return True    
...
#========================================================= Question 3 =========================================================
    ...
    def over_neko(self):
        ...
        for y in range(1, 9): 
            for x in range(8):
                if self.check[y][x] > 0:
                    if self.check[0][x]!=0 and self.check[1][x]!=0:
                        return True
                    if self.check[0][x]!=0 and self.check[1][x]==0:
                        return False
