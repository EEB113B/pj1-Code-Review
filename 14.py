...
#========================================================= Question 1 =========================================================
    ...
    def check_neko(self):
        ...
        for y in range(10): 
            for x in range(1, 8):
                if self.check[y][x] > 0:
                    if self.check[x-1][y] == self.check[y][x] and self.check[x+1][y] == self.check[y][x]:
                        self.neko[x-1][y] = 7
                        self.neko[y][x] = 7
                        self.neko[x+1][y] = 7
        ...
        for y in range(10): 
            for x in range(8):
                if self.check[y][x] > 0:
                    if self.check[x-1][y-1] == self.check[y][x] and self.check[x+1][y+1] == self.check[y][x]:
                        self.neko[x-1][y-1] = 7
                        self.neko[y][x] = 7
                        self.neko[x+1][y+11] = 7
...
#========================================================= Question 2 =========================================================
    ...
    def drop_neko(self):
        ...
        # <<<將你的程式寫在這邊>>>for y in range(8, -1, -1):
            for x in range(8):
                if self.neko[y][x] > 0:
