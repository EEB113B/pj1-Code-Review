...
#========================================================= Question 1 =========================================================
    ...
    def check_neko(self):
        ...
        # <<<將你的程式寫在這邊>>>
        for y in range(1,9):
            for self.check[y][x] > 0:
                if self.neko[y][x-1] == self.check[y][x] and self.check[y][x+1] == self.check[y][x]:
                    self.neko[y][x-1] = 7
                    self.neko[y][x] = 7
                    self.neko[y][x+1] = 7
...
#========================================================= Question 2 =========================================================
    ...
    def drop_neko(self):
        ...
        x = 0
        while x <= 7:
            if self.neko[j][x] != None and self.neko[j+1][x] != None and self.neko[j+1][x] == 0:
