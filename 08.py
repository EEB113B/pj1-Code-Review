...
#========================================================= Question 1 =========================================================
    ...
    def check_neko(self):
        ...
        # 2.判斷左右是否連線
        # <<<將你的程式寫在這邊>>>
                    if self.check[y][x-1] == self.check[y][x] and self.check[y][x+1] == self.check[y][x]:   #檢查橫的是否連線
                        self.neko[y][x-1] = 7
                        self.neko[y][x] = 7
                        self.neko[y][x+1] = 7
        ...
        # <<<將你的程式寫在這邊>>>
                    ...
                    if self.check[y+1][x-1] == self.check[y][x] and self.check[y-1][x+1] == self.check[y][x]:   #檢查左下右上斜角是否連線
                        self.neko[y+1][x-1] = 7
                        self.neko[y][x] = 7
                        self.neko[y-1][x+1] = 7

                    if self.check[y+1][x+1] == self.check[y][x] and self.check[y-1][x-1] == self.check[y][x]:   #檢查左上右下是否連線
                        self.neko[y-1][x-1] = 7
                        self.neko[y][x] = 7
                        self.neko[y-1][x-1] = 7
#========================================================= Question 2 =========================================================
    ...
    def drop_neko(self):
        ...
        for y in range(9, -1, -1):
            for x in range(8):
                if self.neko[y][x] != 0 and self.neko[y+1][x] == 0:   #判斷下面一格是否是空的
                    self.neko[y+1][x] = self.neko[y][x]    #是空的就往下移
                    self.neko[y][x] = 0
                return False
        return True
#========================================================= Question 3 =========================================================
    ...
    def over_neko(self):
        ...
        # <<<將你的程式寫在這邊>>>
        for x in range(8):  
            if self.neko[0][x] != 0:   #如果最上面有東西，就回傳True     
                return True
        return False
#==============================================================================================================================
newgame = CatGame()
